...
Instructor:  
**Asst. Prof. Dr. Chananthorn Chandaeng**  
School of Medical Information Innovation  
Walailak University
...
**Course Code:** IMI62-332  
**Course Title:** Medical Information Security  
**Credits:** 3(3–0–6)

**Class Schedule:**  
📅 Friday, 15:00–18:00  
📍 Computer and Digital Technology Laboratory 1  
...
| **Week** | **Topic**                                                                                  | **Lecture**                                                            | **Workshop / Demonstration**                            | **Assessment**    |
| -------- | ----------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------- | --------------------------------------------- | ----------------- |
...
|---|---|---|
|แบบทดสอบ/แบบฝึกหัด|30%|ทฤษฎีและวิเคราะห์ภัยคุกคาม|
|งานปฏิบัติการ (Labs)|20%|Wireshark, IDS, ML Detection|
